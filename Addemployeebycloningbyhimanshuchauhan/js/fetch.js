        ...
        .then((data) => {
            ...
            if (data['empty']) {
                ...
                for (var i in data) {
		            ...
		            <td align="center"><button class="delete-btn" onclick="editRecord(${data[i].Id})">Clone</button></td>
		          </tr>`;
                }
    ...
    fetch('php/fetch-update.php', {
        ...
        .then((result) => {
            ...
            if (result.update == 'success') {
                ...
                loadTable();
                hide_modal();
                window.location = "http://localhost/Addemployeebycloningbyhimanshuchauhan/";
