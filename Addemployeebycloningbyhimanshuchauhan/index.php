...
<body>
  <div id="main">
    <div id="header">
      <h3 style="text-align:center;">Add employee by cloning:</h3>
      <div id="search-bar">
        <label>Search :</label>
    ...
    <div id="modal-form">
      ...
      <form method="POST">
        <table cellpadding="10px" width="100%" id="edit-form">
          <tr>
            <td >Are you sure ? Do you To want Clone</td>
            <td>
          ...
          <tr>
          <td><button type="button" class="delete-btn" onclick='modify_data()' id='edit-submit'>Clone</button></td>
          </tr>
        </table>
      </form>
      <div id="close-btn" onclick="hide_modal()">X</div>
